	            ...
	            <div class="" >
	                ...
	                <div class="panel-body form-horizontal payment-form">
	                	<div class="form-group">
	                        ...
	                        <div class="col-sm-6">
	                            <input type="text" class="form-control" id="viewId"  placeholder="請輸入景點代號(不可重複)" name="viewId">
	                    ...
	                    <div class="form-group">
	                        ...
	                        <div class="col-sm-6">
	                            <input type="text" class="form-control" id="viewName"  placeholder="請輸入景點名稱" name="viewName">
	                    ...
	                    <div class="form-group">
	                        ...
	                        <div class="col-sm-9">
	                            <input type="text" class="form-control" id="viewAddr"  placeholder="景點地址" name="viewAddr">
