...
<%
	    ...
	    newsVO nsVO = new newsDAO().getOne((session.getAttribute("id").toString()));
%>
	            ...
	            <div class="" >
	                ...
	                <div class="panel-body form-horizontal payment-form">
	                	<div class="form-group">
	                        ...
	                        <div class="col-sm-7">
	                            <input type="text" class="form-control" id="news_title"  placeholder="請輸入最新消息主題" name="news_title" value="<%=nsVO.getNews_title()%>">
